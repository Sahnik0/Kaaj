...
export default function About() {
  ...
  <div className="container mx-auto relative z-10">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        { img: "/sahnik1.jpg", name: "Sahnik Kumar", role: "Co-Founder" },
        { img: "/sankalpa.jpg", name: "Sankalpa Saha", role: "Product Manager" },
        { img: "/Shov_PIC.jpg", name: "Shovon Bhattacharjee", role: "Lead Developer" },
        { img: "/shreyas.jpg", name: "Shreyas Shukla", role: "UI/UX Designer" },
