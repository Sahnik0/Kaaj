  ...
  <div className="container mx-auto relative z-10">
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
      {[
        ...
        { img: "/sankalpa.jpg", name: "Sankalpa Saha", role: "Co-Founder" },
        { img: "/Shov_PIC.jpg", name: "Shovon Bhattacharjee", role: "Co-Founder" },
        { img: "/shreyas.jpg", name: "Shreyas Shukla", role: "UCo-FounderCo-Founder" },
