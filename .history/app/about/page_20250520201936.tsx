...
export default function About() {
  ...
  const teamMembers = [
  {
    name: "Alice Johnson",
    role: "Founder & CEO",
    image: "/team/alice.jpg", // Put the images in the public/team folder
  },
  {
    name: "Bob Smith",
    role: "CTO",
  ...
  <div className="container mx-auto">
    <div className="text-center mb-12">
      ...
      <p className="max-w-2xl mx-auto text-muted-foreground">{t("about.team.description")}</p>
    </div>
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
      {teamMembers.map((member) => (
        <div
          key={member.name}
          className="flex flex-col items-center bg-white dark:bg-gray-700 rounded-lg shadow-md p-6 border border-gray-200 dark:border-gray-600"
        >
          <img
            src={member.image}
            alt={member.name}
