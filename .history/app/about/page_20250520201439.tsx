      ...
      <main className="flex-1">
        ...
        <section className="py-16 px-4 bg-gray-50 dark:bg-gray-900 relative overflow-hidden">
          ...
          <div className="container mx-auto relative z-10">
            ...
            const teamMembers = [
  { id: 1, name: "Team Member 1", role: "Co-Founder", imgSrc: "/sahnik.jpg" },
  { id: 2, name: "Team Member 2", role: "CTO", imgSrc: "/member2.jpg" },
  { id: 3, name: "Team Member 3", role: "Designer", imgSrc: "/member3.jpg" },
  { id: 4, name: "Team Member 4", role: "Developer", imgSrc: "/member4.jpg" },
];

<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
  {teamMembers.map(({ id, name, role, imgSrc }) => (
    <div
      key={`team-member-${id}`}
