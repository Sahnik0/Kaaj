...
const translations = {
  en: {
    ...
    "about.story.description":
      "Founded in 2023, we started with a simple idea: make it easier for people to find and offer services locally. What began as a small project has grown into a thriving marketplace serving communities worldwide.",
