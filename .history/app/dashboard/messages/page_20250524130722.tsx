...
import { Send, User, Search, X, Loader2, Phone, Video, PhoneOff, MoreVertical, Archive, Trash2, Pin, Smile, MessageCircle, Clock, CheckCheck, Check, PlusCircle, Paperclip, Mic, Image, Heart, ThumbsUp, Laugh, Angry, FrownIcon as Sad, Reply, Star, Zap, Sparkles, Volume2, VolumeX, Settings, Filter, SortDesc } from 'lucide-react'
