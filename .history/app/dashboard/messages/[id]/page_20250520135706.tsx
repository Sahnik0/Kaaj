...
import { Send, ArrowLeft, Loader2, Video, PhoneCall, Mic, MicOff, VideoOff, User } from "lucide-react"
          ...
          <div className="absolute inset-0 z-10 bg-black flex flex-col">
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <span className="font-bold">
                    {activeCall?.status === "accepted" ? "Video call with" : "Calling"} {otherUser.displayName}
                  </span>
                  {activeCall?.status !== "accepted" && (
                    <p className="text-xs text-yellow-400">Waiting for answer...</p>
                  )}
                </div>
              </div>
              <Button
            ...
            <div className="flex-1 flex items-center justify-center relative">
              ...
              <div className="w-full h-full bg-gray-900 flex items-center justify-center">
                {activeCall?.status === "accepted" ? (
                  <Video className="h-24 w-24 text-yellow-400" />
                ) : (
                  <div className="flex flex-col items-center">
                    <Loader2 className="h-16 w-16 text-yellow-400 animate-spin mb-4" />
                    <p className="text-yellow-400 font-bold">Calling {otherUser.displayName}...</p>
                  </div>
                )}
              </div>
