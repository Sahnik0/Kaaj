          ...
          <div className="absolute inset-0 z-10 bg-black flex flex-col">
            <div className="flex justify-between items-center p-4 bg-black text-white border-b-2 border-yellow-400">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold">Video call with {otherUser.displayName}</span>
              </div>
              <Button
                variant="destructive"
                size="sm"
            ...
            <div className="flex-1 flex items-center justify-center relative">
              ...
              <div className="w-full h-full bg-gray-900 flex items-center justify-center">
                ...
                <p className="text-yellow-400 absolute bottom-24 font-bold">Connecting to {otherUser.displayName}...</p>
              </div>
