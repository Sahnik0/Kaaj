...
export default function Messages() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Zego Cloud Call Dialog */}
      <Dialog open={callActive} onOpenChange={(open) => !open && endCall()}>
        <DialogContent className="sm:max-w-[800px] md:max-w-[1000px] lg:max-w-[1200px] h-[80vh]">
          <DialogHeader>
            <DialogTitle>
              {callType === "audio" ? "Audio Call" : "Video Call"} with {callRecipient?.name}
            </DialogTitle>
            <DialogDescription>
              {callType === "audio" ? "Audio call powered by Zego Cloud" : "Video call powered by Zego Cloud"}
            </DialogDescription>
          </DialogHeader>
