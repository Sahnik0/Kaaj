...
export default function Messages() {
  ...
  const agoraToken =
    "007eJxTYDDuX2kRtb9U7ujvFGf3Wbe5WJ9zuDLuKcwP3v934lt9Zz4FBjNzY9O0JOPERANDS5NUo1QLS4ukNHNDIDfV0szU0iLXUCejIZCR4RpPNyMjAwSC+DwMJanFJfHJGYl5eak5DAwAwCQgXQ=="

  // In a production app, you would generate this dynamically for each call
  const generateChannelName = (conversationId: string) => {
    // Use a simple channel name for testing with the provided token
    return "test_channel"
  }
  ...
  const startVideoCall = async () => {
    ...
    try {
      ...
      // Generate a numeric UID from the user's Firebase UID
      const uid = user?.uid
      ...
      // Join the channel using the provided token
              ...
              <CardHeader className="px-4 py-3 border-b border-kaaj-100 bg-gradient-to-br from-kaaj-50 to-kaaj-100/60">
                <div className="flex items-center gap-3">
                  ...
                  <div className="ml-auto">
                    ...
                    >
                      {isConnecting ? <Loader2 className="h-4 w-4 animate-spin" /> : <Video className="h-4 w-4" />}
                    </Button>
                  </div>
                </div>
              </CardHeader>
