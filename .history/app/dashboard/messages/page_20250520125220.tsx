...
export default function Messages() {
  ...
  // Agora configuration
  const appId = "6735fb3aa0194e2e898bf71a01e96598"
  ...
  const startVideoCall = async () => {
    ...
    try {
      ...
      // In a production app, you would get a token from your server
      // For this example, we're using null which works for development with security disabled
      await client.join(appId, channelName, null, user?.uid || Math.floor(Math.random() * 100000))
      ...
      // 1. Notify the other user through your Firebase backend
  ...
  const videoCallRecipientId = null
