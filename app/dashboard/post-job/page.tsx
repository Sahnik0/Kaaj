    ...
    <PageContainer>
      ...
      <Tabs defaultValue="regular" onValueChange={(value) => setJobType(value as "regular" | "task")} className="w-full">
        <div className="flex items-center justify-between mb-4">
          ...
          <Badge variant="outline" className="bg-kaaj-50 text-kaaj-700 gap-1">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-2">
                  ...
                  />
                  <p className="text-xs text-muted-foreground">Provide a clear and concise description of the role and responsibilities.</p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Textarea
                    ...
                    className="min-h-32 focus-visible:ring-kaaj-500"
                  />
                  <p className="text-xs text-muted-foreground">List specific skills, experience, and qualifications needed for this position.</p>
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className="flex items-center space-x-2 rounded-md border p-3 hover:bg-muted/50 cursor-pointer">
                        ...
                        <Label htmlFor="remote" className="font-normal cursor-pointer w-full">
                          Remote
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 rounded-md border p-3 hover:bg-muted/50 cursor-pointer">
                        <RadioGroupItem value="offline" id="offline" className="text-kaaj-500" />
                        <Label htmlFor="offline" className="font-normal cursor-pointer w-full">
                          In-Person
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 rounded-md border p-3 hover:bg-muted/50 cursor-pointer">
                        <RadioGroupItem value="hybrid" id="hybrid" className="text-kaaj-500" />
                        <Label htmlFor="hybrid" className="font-normal cursor-pointer w-full">
                          Hybrid
                        </Label>
                      </div>
                    </RadioGroup>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="salary" className="font-medium">Salary/Compensation</Label>
                    <Input
                      id="salary"
                      name="salary"
                  ...
                  <div className="space-y-3">
                    <Label className="font-medium">Job Duration</Label>
                    <RadioGroup
                    ...
                    >
                      <div className="flex items-center space-x-2 rounded-md border p-3 hover:bg-muted/50 cursor-pointer">
                        ...
                        <Label htmlFor="long-term" className="font-normal cursor-pointer w-full">
                          Long-term (Ongoing position)
                        </Label>
                      </div>
                      <div className="flex items-center space-x-2 rounded-md border p-3 hover:bg-muted/50 cursor-pointer">
                        <RadioGroupItem value="quick" id="quick" className="text-kaaj-500" />
                        <Label htmlFor="quick" className="font-normal cursor-pointer w-full">
                ...
                <Alert status="info" className="flex items-start bg-blue-50 border-blue-100">
                  <div>
                    <Alert.Title className="text-blue-800 font-medium">Job Posting Tips</Alert.Title>
                    <Alert.Description className="text-blue-700 text-sm mt-1">
              ...
              <CardFooter className="flex justify-end gap-3 border-t p-4 bg-muted/50">
                ...
                <Button type="submit" disabled={isLoading} className="bg-kaaj-500 hover:bg-kaaj-600">
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-2">
                  ...
                  <Label htmlFor="category" className="font-medium">Task Category</Label>
                  <Select
                    value={formData.category}
                    onValueChange={(value) => handleSelectChange("category", value)}
                    required
                  ...
                  <div className="space-y-3">
                    ...
                    >
                      <div className={`flex items-center gap-3 rounded-md border p-3 hover:bg-muted/50 cursor-pointer ${formData.urgency === "low" ? "border-kaaj-200 bg-kaaj-50" : ""}`}>
                        ...
                        <div>
                          <Label htmlFor="urgency-low" className="font-medium cursor-pointer">
                            Low
                          </Label>
                      ...
                      <div className={`flex items-center gap-3 rounded-md border p-3 hover:bg-muted/50 cursor-pointer ${formData.urgency === "normal" ? "border-kaaj-200 bg-kaaj-50" : ""}`}>
                        ...
                        <div>
                          <Label htmlFor="urgency-normal" className="font-medium cursor-pointer">
                            Normal
                          </Label>
                      ...
                      <div className={`flex items-center gap-3 rounded-md border p-3 hover:bg-muted/50 cursor-pointer ${formData.urgency === "high" ? "border-kaaj-200 bg-kaaj-50" : ""}`}>
                        ...
                        <div>
                          <Label htmlFor="urgency-high" className="font-medium cursor-pointer">
                            High
                          </Label>
